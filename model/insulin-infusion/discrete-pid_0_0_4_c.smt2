...
(assert (>= DG1_0_0 46.29354887132181))
(assert (>= DG1_0_t 46.29354887132181))
(assert (<= DG1_0_0 46.29354887132183))
(assert (<= DG1_0_t 46.29354887132183))
(assert (>= DG2_0_0 69.33381440519106))
(assert (>= DG2_0_t 69.33381440519106))
(assert (<= DG2_0_0 69.33381440519111))
(assert (<= DG2_0_t 69.33381440519111))
(assert (>= DG3_0_0 59.1152763669042))
(assert (>= DG3_0_t 59.1152763669042))
(assert (<= DG3_0_0 59.11527636690423))
(assert (<= DG3_0_t 59.11527636690423))
(assert (>= tau_meal_1_0_0 283.9239067284418))
(assert (>= tau_meal_1_0_t 283.9239067284418))
(assert (<= tau_meal_1_0_0 283.923906728442))
(assert (<= tau_meal_1_0_t 283.923906728442))
(assert (>= tau_meal_2_0_0 299.1896309310579))
(assert (>= tau_meal_2_0_t 299.1896309310579))
(assert (<= tau_meal_2_0_0 299.189630931058))
(assert (<= tau_meal_2_0_t 299.189630931058))
(assert (>= Kd_0_0 0))
(assert (>= Kd_0_t 0))
(assert (<= Kd_0_0 0))
(assert (<= Kd_0_t 0))
...
(assert (and (>= G1_0_0 5.850188314993778) (<= G1_0_0 5.85018831499525)))
(assert (and (>= G2_0_0 22.29325755813052) (<= G2_0_0 22.29325755813681)))
(assert (and (>= I_0_0 0.04708863557551123) (<= I_0_0 0.04708863557569294)))
(assert (and (>= Q1_0_0 162.4504329042007) (<= Q1_0_0 162.4504329053063)))
(assert (and (>= Q1_prev_0_0 162.4504329042007) (<= Q1_prev_0_0 162.4504329053063)))
(assert (and (>= Q2_0_0 41.12666260662648) (<= Q2_0_0 41.12666260702496)))
(assert (and (>= S1_0_0 4.824133748857047) (<= S1_0_0 4.824133748879911)))
(assert (and (>= S2_0_0 4.354036055435023) (<= S2_0_0 4.354036055452268)))
(assert (and (>= counter_0_0 -4.940656458412465e-324) (<= counter_0_0 4.940656458412465e-324)))
(assert (and (>= e_0_0 -64.67265512752856) (<= e_0_0 -64.67265512642292)))
(assert (and (>= e_der_0_0 0.4543244474120512) (<= e_der_0_0 0.4543244476564554)))
(assert (and (>= e_int_0_0 -38797.40110796465) (<= e_int_0_0 -38797.40110776037)))
(assert (and (>= r_0_0 97.77777777777776) (<= r_0_0 97.77777777777779)))
(assert (and (>= tau_0_0 152.1521865431113) (<= tau_0_0 152.1521865431211)))
(assert (and (>= u_0_0 0.03513187868420224) (<= u_0_0 0.03513187868476891)))
(assert (and (>= x1_0_0 0.0266299131922525) (<= x1_0_0 0.02662991319231619)))
(assert (and (>= x2_0_0 0.04245803298209937) (<= x2_0_0 0.04245803298225515)))
(assert (and (>= x3_0_0 0.03575741707039013) (<= x3_0_0 0.0357574170705158)))
