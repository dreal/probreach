...
(assert (<= 1 mode_1))
(assert (<= mode_1 2))
(assert (and (and (= Q2_0_0 40) (= Q1_0_0 64) (= S2_0_0 4) (= S1_0_0 4.2) (= tau_0_0 0) (<= x3_0_0 0.0664063) (>= x3_0_0 0.065625) (= x2_0_0 0.045) (= x1_0_0 0.03) (= I_0_0 0.03)) (= mode_0 1) (= [x3_0_t x2_0_t x1_0_t tau_0_t S2_0_t S1_0_t Q2_0_t Q1_0_t I_0_t] (integral 0. time_0 [x3_0_0 x2_0_0 x1_0_0 tau_0_0 S2_0_0 S1_0_0 Q2_0_0 Q1_0_0 I_0_0] flow_1)) (= mode_0 1) (= mode_1 2) (= (/ Q1_0_t (* 0.16 100)) 10) (= Q2_1_0 Q2_0_t) (= Q1_1_0 Q1_0_t) (= S2_1_0 S2_0_t) (= S1_1_0 S1_0_t) (= tau_1_0 0) (= x3_1_0 x3_0_t) (= x2_1_0 x2_0_t) (= x1_1_0 x1_0_t) (= I_1_0 I_0_t) (= [x3_1_t x2_1_t x1_1_t tau_1_t S2_1_t S1_1_t Q2_1_t Q1_1_t I_1_t] (integral 0. time_1 [x3_1_0 x2_1_0 x1_1_0 tau_1_0 S2_1_0 S1_1_0 Q2_1_0 Q1_1_0 I_1_0] flow_2)) (= mode_1 2) (= mode_1 2) (<= (/ Q1_1_t (* 0.16 100)) 10) (= tau_1_t 60)))
(check-sat)
(exit)
