...
(assert (>= the_in_0_0 32.31604201577989))
(assert (>= the_in_0_t 32.31604201577989))
(assert (<= the_in_0_0 32.31604201577991))
(assert (<= the_in_0_t 32.31604201577991))
(assert (>= w_0_0 106.0054455078404))
(assert (>= w_0_t 106.0054455078404))
(assert (<= w_0_0 106.0054455078405))
(assert (<= w_0_t 106.0054455078405))
(assert (>= Kd_0_0 0))
(assert (>= Kd_0_t 0))
(assert (<= Kd_0_0 0))
(assert (<= Kd_0_t 0))
...
(assert (and (>= e_0_0 0.01842024062260705) (<= e_0_0 0.01907074415518473)))
(assert (and (>= e_der_0_0 0.9777265247656606) (<= e_der_0_0 0.9923093936166439)))
(assert (and (>= e_int_0_0 -0.2601619432793761) (<= e_int_0_0 -0.2591726310321215)))
(assert (and (>= lambda_0_0 14.71842024062261) (<= lambda_0_0 14.71907074415518)))
(assert (and (>= lambda_prev_0_0 14.71842024062261) (<= lambda_prev_0_0 14.71907074415518)))
(assert (and (>= p_0_0 0.9988094435058851) (<= p_0_0 0.9988094435058883)))
(assert (and (>= pe_0_0 0.8354263315122924) (<= pe_0_0 0.8354263384442414)))
(assert (and (>= tau_0_0 0.6999999867274684) (<= tau_0_0 0.7000000000000008)))
(assert (and (>= the_0_0 32.31604201573541) (<= the_0_0 32.31604201573656)))
(assert (and (>= u_0_0 0.003450371244988054) (<= u_0_0 0.003572219744665877)))
