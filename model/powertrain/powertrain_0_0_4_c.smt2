...
(assert (>= the_in_0_0 30.82960699192818))
(assert (>= the_in_0_t 30.82960699192818))
(assert (<= the_in_0_0 30.82960699192819))
(assert (<= the_in_0_t 30.82960699192819))
(assert (>= w_0_0 107.3337162012348))
(assert (>= w_0_t 107.3337162012348))
(assert (<= w_0_0 107.3337162012348))
(assert (<= w_0_t 107.3337162012348))
(assert (>= Kd_0_0 0))
(assert (>= Kd_0_t 0))
...
(assert (and (>= e_0_0 0.01953193120921703) (<= e_0_0 0.02005844479730357)))
(assert (and (>= e_der_0_0 0.3059915465743578) (<= e_der_0_0 0.3178513299646291)))
(assert (and (>= e_int_0_0 -0.2294310059587401) (<= e_int_0_0 -0.2284937816035812)))
(assert (and (>= lambda_0_0 14.71953193120922) (<= lambda_0_0 14.7200584447973)))
(assert (and (>= lambda_prev_0_0 14.71953193120922) (<= lambda_prev_0_0 14.7200584447973)))
(assert (and (>= p_0_0 0.9985573129501698) (<= p_0_0 0.9985573129501747)))
(assert (and (>= pe_0_0 0.8379953083798296) (<= pe_0_0 0.8379953485955041)))
(assert (and (>= tau_0_0 0.09999999999999995) (<= tau_0_0 0.1)))
(assert (and (>= the_0_0 30.8296069465185) (<= the_0_0 30.82960694652238)))
(assert (and (>= u_0_0 0.003658606593914788) (<= u_0_0 0.003757230025695569)))
; defining the integral
(assert (= [Kd_0_t Ki_0_t Kp_0_t counter_0_t e_0_t e_der_0_t e_int_0_t lambda_0_t lambda_prev_0_t p_0_t pe_0_t tau_0_t the_0_t the_in_0_t u_0_t w_0_t ] (integral 0.0 time [Kd_0_0 Ki_0_0 Kp_0_0 counter_0_0 e_0_0 e_der_0_0 e_int_0_0 lambda_0_0 lambda_prev_0_0 p_0_0 pe_0_0 tau_0_0 the_0_0 the_in_0_0 u_0_0 w_0_0 ] flow_3)))
