...
(assert (>= the_in_0_0 31.84299384648356))
(assert (>= the_in_0_t 31.84299384648356))
(assert (<= the_in_0_0 31.84299384648357))
(assert (<= the_in_0_t 31.84299384648357))
(assert (>= w_0_0 106.5993047455657))
(assert (>= w_0_t 106.5993047455657))
(assert (<= w_0_0 106.5993047455657))
(assert (<= w_0_t 106.5993047455657))
(assert (>= Kd_0_0 0))
(assert (>= Kd_0_t 0))
...
(assert (and (>= e_0_0 -0.02618388718469333) (<= e_0_0 -0.02542128894173601)))
(assert (and (>= e_der_0_0 0.04890720780066359) (<= e_der_0_0 0.06614172229342687)))
(assert (and (>= e_int_0_0 -0.2293844913935754) (<= e_int_0_0 -0.2288226461580135)))
(assert (and (>= lambda_0_0 14.67381611281531) (<= lambda_0_0 14.67457871105826)))
(assert (and (>= lambda_prev_0_0 14.67381611281531) (<= lambda_prev_0_0 14.67457871105826)))
(assert (and (>= p_0_0 0.9987305280308495) (<= p_0_0 0.9987305280308774)))
(assert (and (>= pe_0_0 0.8433098981614109) (<= pe_0_0 0.8433100118351988)))
(assert (and (>= tau_0_0 1.599993064494486) (<= tau_0_0 1.600000000000001)))
(assert (and (>= the_0_0 31.8429912531559) (<= the_0_0 31.84299125333701)))
(assert (and (>= u_0_0 -0.004904611903559951) (<= u_0_0 -0.004761766481348198)))
