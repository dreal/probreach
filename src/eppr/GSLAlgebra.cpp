...
std::shared_ptr<IMatrix>
GSLAlgebra::createMatrix(std::vector<std::vector<double>> &data)
{
  resultMatrix = std::make_shared<MatrixGSL>(data);
  return resultMatrix;
}
...
std::shared_ptr<IMatrix>
GSLAlgebra::invertPositive(std::shared_ptr<IMatrix> arg)
{
...
std::shared_ptr<IMatrix>
GSLAlgebra::solve(std::shared_ptr<IMatrix> A, std::shared_ptr<IMatrix> B)
{
...
std::shared_ptr<IMatrix> GSLAlgebra::solvePositive(
...
void GSLAlgebra::solvePositiveInPlace(
  std::shared_ptr<IMatrix> A,
  std::shared_ptr<IMatrix> B)
{
  MatrixGSL *A_ = dynamic_cast<MatrixGSL *>(A.get());
...
/**
	...
	*/
std::vector<std::shared_ptr<IMatrix>> &
GSLAlgebra::svd(std::shared_ptr<IMatrix> arg)
{
