...
class GSLAlgebra : public IAlgebra
{
public:
  GSLAlgebra(void);
  ...
  createMatrix(std::vector<std::vector<double>> &data);
  ...
  virtual std::shared_ptr<IMatrix>
  solve(std::shared_ptr<IMatrix> A, std::shared_ptr<IMatrix> B);

  virtual std::shared_ptr<IMatrix>
  solvePositive(std::shared_ptr<IMatrix> A, std::shared_ptr<IMatrix> B);

  virtual void
  solvePositiveInPlace(std::shared_ptr<IMatrix> A, std::shared_ptr<IMatrix> B);
  ...
  svd(std::shared_ptr<IMatrix> arg);
