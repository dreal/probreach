...
public:
  ...
  calculateCovariances(std::shared_ptr<KernelFunction> func);
  std::shared_ptr<std::vector<std::vector<double>>> calculateCovariances(
...
public:
  ...
  calculateVariances(std::shared_ptr<KernelFunction> func);
  bool isModified();
};
