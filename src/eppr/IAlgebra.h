...
public:
  ...
  virtual std::shared_ptr<IMatrix>
  createMatrix(std::vector<std::vector<double>> &data) = 0;
  ...
  virtual std::shared_ptr<IMatrix>
  invertPositive(std::shared_ptr<IMatrix> arg) = 0;

  virtual std::shared_ptr<IMatrix>
  solve(std::shared_ptr<IMatrix> A, std::shared_ptr<IMatrix> B) = 0;

  virtual std::shared_ptr<IMatrix>
  solvePositive(std::shared_ptr<IMatrix> A, std::shared_ptr<IMatrix> B) = 0;

  virtual void solvePositiveInPlace(
  ...
  /**
	 ...
	 */
  virtual std::vector<std::shared_ptr<IMatrix>> &
  svd(std::shared_ptr<IMatrix> arg) = 0;
