...
class IAlgebra {
 public:
  ...
  virtual std::shared_ptr<IMatrix> createMatrix(
  ...
  virtual std::shared_ptr<IMatrix> invertPositive(
      std::shared_ptr<IMatrix> arg) = 0;

  virtual std::shared_ptr<IMatrix> solve(std::shared_ptr<IMatrix> A,
                                         std::shared_ptr<IMatrix> B) = 0;

  virtual std::shared_ptr<IMatrix> solvePositive(
      std::shared_ptr<IMatrix> A, std::shared_ptr<IMatrix> B) = 0;

  virtual void solvePositiveInPlace(std::shared_ptr<IMatrix> A,
                                    std::shared_ptr<IMatrix> B) = 0;
   ...
   */
  virtual std::vector<std::shared_ptr<IMatrix>>& svd(
      std::shared_ptr<IMatrix> arg) = 0;
