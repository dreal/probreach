...
double KernelRBF::calculateDerivative(
...
double KernelRBF::calculateSecondDerivative(
  std::vector<double> &x1,
  std::vector<double> &x2,
  int i,
  int j)
...
double KernelRBF::calculateHyperparamDerivative(
  std::vector<double> &x1,
  std::vector<double> &x2,
  int hyperparamIndex)
{
...
std::vector<double> &
KernelRBF::getDefaultHyperarameters(std::shared_ptr<GpDataset> data)
{
