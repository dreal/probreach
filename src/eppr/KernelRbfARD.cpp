...
double KernelRbfARD::calculateDerivative(
...
double KernelRbfARD::calculateSecondDerivative(
  std::vector<double> &x1,
  std::vector<double> &x2,
  int i,
  int j)
...
double KernelRbfARD::calculateHyperparamDerivative(
  std::vector<double> &x1,
  std::vector<double> &x2,
  int hyperparamIndex)
{
...
std::vector<double> &
KernelRbfARD::getDefaultHyperarameters(std::shared_ptr<GpDataset> data)
{
