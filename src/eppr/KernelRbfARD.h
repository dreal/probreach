...
class KernelRbfARD : public KernelFunction {
 public:
  ...
  virtual double calculateDerivative(std::vector<double>& x1,
                                     std::vector<double>& x2, int derivativeI);
  virtual double calculateSecondDerivative(std::vector<double>& x1,
                                           std::vector<double>& x2,
                                           int derivativeI, int derivativeJ);
  virtual double calculateHyperparamDerivative(std::vector<double>& x1,
                                               std::vector<double>& x2,
                                               int hyperparamIndex);
  virtual std::vector<double>& getHyperparameters(void);
  virtual std::vector<double>& getDefaultHyperarameters(
