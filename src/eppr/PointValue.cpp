...
PointValue::PointValue(std::shared_ptr<std::vector<double> > point,
                       double value) {
  this->point = point;
  this->value = value;
}
...
std::shared_ptr<std::vector<double> > PointValue::getPoint() { return point; }

double PointValue::getValue() { return value; }
