...
std::string measure::gaussian(std::string var, double mu, double sigma)
{
    std::stringstream s;
...
std::string measure::exp(std::string var, double lambda)
{
    std::stringstream s;
...
std::string measure::uniform(std::string var, double a, double b)
{
    std::stringstream s;
    s << "1 / (" << b << " - " << a << ")";
    return s.str();
...
std::map<capd::interval, std::vector<capd::interval>> measure::integral(std::string var, std::string fun, capd::interval it, double e)
{
    ...
    std::map<capd::interval, std::vector<capd::interval>> res;
    res.insert(make_pair(value, partition));
