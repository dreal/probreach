...
box solve_odes_nonrig(map<string, pdrh::node*>, box, capd::interval,
                      vector<box>);
box solve_odes_discrete(map<string, pdrh::node*>, box, capd::interval, size_t,
                        vector<box>);
...
capd::interval compute_max_robustness(vector<vector<pdrh::mode*>>, box,
                                      vector<box>);
capd::interval compute_min_robustness(vector<vector<pdrh::mode*>>, box,
                                      vector<box>);
