...
namespace measure {
std::pair<capd::interval, std::vector<capd::interval>> integral(std::string,
                                                                std::string,
                                                                capd::interval,
                                                                double);
...
bool ascending(const pair<box, capd::interval> &,
               const pair<box, capd::interval> &);
bool descending(const pair<box, capd::interval> &,
                const pair<box, capd::interval> &);
}  // namespace compare_pairs
...
std::pair<capd::interval, std::vector<capd::interval>> pdf(std::string,
                                                           std::string,
                                                           capd::interval,
                                                           double, double);
box get_rv_domain();
